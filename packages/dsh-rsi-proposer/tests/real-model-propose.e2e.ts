 ...
 *
 * The parent is the @dsh-rsi/candidate-baseline (the stable baseline). Evidence
...
import { declareFiles } from '@dsh-rsi/candidate-sdk'
...
beforeEach(async () => {
  scratch = await mkdtemp(join(tmpdir(), 'dsh-rsi-propose-'))
})
