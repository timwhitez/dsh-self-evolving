 ...
 * - SHA256SUMS commits to the complete tree: symlink targets are hashed, and
 *   verification rejects tampered targets and unlisted extra entries.
 */
...
import { buildCandidate, packCapsule } from '../src/index.js'
